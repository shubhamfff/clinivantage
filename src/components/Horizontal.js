...
function CheifComplaintsComponent() {
    ...
    return (
        ...
        <Grid sx={{ width: '100%' }} container
            ...
            <Box
                sx={{ flexGrow: 1, bgcolor: 'background.paper', width: '100%' }}
            >
                <Tabs
                    variant="scrollable"
                ...
                <TabPanel value={value} index={0}>
                    <TextField sx={{ width:'100%', backgroundColor:'primary.back' }} id="filled-basic" label="Add Notes"  />

                    <TableContainer component={Paper} elevation={0}>
                        <Table sx={{ mt: 5 }} size="small" aria-label="a dense table">
                            <TableHead>
                                <TableRow>
